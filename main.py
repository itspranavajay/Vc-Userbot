...
GITHUBLINK = """ Source code: [Github](https://github.com/Moezilla/vc-userbot)
...
@app.on_message(filters.me & filters.command("github", PREFIX))
async def github(_, message):
    await message.reply_text(GITHUBLINK)
